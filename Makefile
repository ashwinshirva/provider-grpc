...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Grpc CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Grpc controllers
...
# This target prepares repo for your provider by replacing all "grpc"
